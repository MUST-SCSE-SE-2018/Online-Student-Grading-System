...
-- insert data
INSERT Teacher(tid, tName, psw, emailAddress) 
...
INSERT Student(stuid, sName, psw, emailAddress) 
...
INSERT Course(indexNumber, cid, cName, stuid, tid) 
...
INSERT Assignment(aid, aname, cid, q_number, [weight], tid, deadline) 
...
INSERT Question(qid, q_index, aid, content) 
...
INSERT Answer(ansid, qid, stuid, content, tcomment) 
VALUES 
       (11, 8, '1809853J-I011-0013', 'CREATE', ''),
...
INSERT Submit(subid, aid, stuid, grade, comment, stat) 
